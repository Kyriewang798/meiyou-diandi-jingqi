...
function createScene1ForecastEntry(options = {}){
  ...
  return {
    ...
    followUpEntry:{
      ...
      contextText: options.splitFeedback ? SCENE1_FORECAST_QUESTION : undefined,
      contextKey: options.splitFeedback ? 'forecast-feedback' : undefined,
    },
    extractDoneAt:now + SCENE1_EXTRACT_MS,
  };
}
