...
const DEMO_SCENES = {
  'note-quick-record': {
    ...
    getTimeline: ()=>{
      ...
      if(demo === 'focused-input-flow-v1' || demo === 'focused-input-flow-v2'){
        return window.buildFocusedInputFlowTimeline();
      }
      if(demo === 'structured-timeline-v2'){
        return window.buildStructuredDemoTimeline();
      }
