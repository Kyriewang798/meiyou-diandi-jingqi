// Demo 场景配置（v4）— 控制默认 Tab、页面展示与交互流程
//
// v4 = 09-17 上午版 v2（commit 3276474）：反馈折叠成一行对话栏，点进二级页看分析。
// 页面顶部中央提供「场景1 / 场景2 / 场景3」切换；原场景4 是场景2 的副本，已从切换条去掉。
// 场景3 的初始时间轴额外叠加场景1整个交互的播放完成态。
...
function DemoSceneBar({ value, onChange, description }) {
  ...
  return (
    <div className="v2-scene-bar" role="toolbar" aria-label="演示场景切换">
      <span className="v2-scene-bar-tag">v4</span>
